...
export default function ValueCalculator() {
  ...
  const [avgTicketSize, setAvgTicketSize] = useState<number>(10000);
  const [conversionRate, setConversionRate] = useState<number>(1.5); // representative conversion rate (percent)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-display text-3xl sm:text-4xl font-extrabold text-white tracking-tight mt-3 mb-4">
            See the Value Before You Book
          </h2>
          <p className="text-slate-400 text-base">
            Configure your client acquisition stats below to calculate the ROI potential of a ByteDepth premium lead capture page compared to our cost of just ₹9,999.
          </p>
        </div>
          ...
          <div className="bg-slate-800/80 border border-slate-700 p-6 md:p-8 rounded-3xl flex flex-col justify-between space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-sm font-medium">
                <label className="text-slate-300">Estimated Monthly Visitors</label>
              ...
              <span className="text-[10px] text-slate-500 block leading-tight">
                (Standard referrals, organic local searches, maps hits, or Google Ad placements)
              </span>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-sm font-medium">
                <label className="text-slate-300">Your Avg Service Fee (Standard Retainer)</label>
                <span className="text-blue-400 font-mono font-bold text-base">
              ...
              />
              <span className="text-[10px] text-slate-500 block leading-tight">
                (What a typical legal case, audit, training contract, or consulting deal pays you)
              </span>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-sm font-medium">
                <label className="text-slate-300">Landing Page Action Rate</label>
              ...
              />
              <span className="text-[10px] text-slate-500 block leading-tight">
                (Conversion percentage taking action. Our pages routinely beat standard 1.0% averages)
              </span>
            </div>

            {/* Quick trust note */}
            <div className="pt-4 border-t border-slate-700 text-xs text-slate-400 italic">
              *Calculations are highly conservative estimates modeled on service industry averages.
            </div>
            ...
            <div className="space-y-6 my-auto">
              ...
              <div className="flex justify-between items-end border-b border-blue-900 pb-3">
                ...
                <div className="text-right">
                  ...
                  <span className="text-xs text-slate-400 font-medium block">Inquiries / Mo</span>
                </div>
              </div>
              ...
              <div className="flex justify-between items-end border-b border-blue-900 pb-3">
                <div>
                  <span className="text-xs text-slate-400 block">Projected Revenue Lift</span>
            ...
            <div className="mt-8 pt-4 border-t border-blue-900/50">
              <div className="flex items-start space-x-2 bg-blue-900/40 p-3 rounded-lg">
                ...
                <p className="text-xs text-slate-200">
                  Bytedepth builds systems that achieve payback based on capturing as little as <span className="font-bold underline decoration-blue-400 text-white">one single client</span>. Keep 100% of the recurring profits.
                </p>
              </div>
            </div>
